...
{ 
	pushEvent_({ m::eventDispatcher::EventType::SEQUENCER_START, 0 }, t);
...
{ 
	pushEvent_({ m::eventDispatcher::EventType::SEQUENCER_STOP, 0 }, t);
}
...
{ 
	pushEvent_({ m::eventDispatcher::EventType::SEQUENCER_REWIND }, t);
}
